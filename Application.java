...
class AppDemo extends JFrame implements ItemListener //Class containing all the components
{
	...
	static JPanel p, login_p, p_s, p1, p_c, p2, p3, ptc, pcoc, topPanel, tcPanel, cocPanel, cpPanel;
	static JButton reset, next, submit, print, update, submit_2, go_to, data, clr, prt, home, login_btn, logout, yes, ok, Ok, tc_button, coc_button, goToCoc, view, reset_2, forgotPassword, submit_3, backToLogin, changePassword;
	static Font f, ff, fff, ffff, fffff,ffffff, fo, fb, fffs, fbold, fcoc, f_f, ffor;
	static Color col, col2;
	static JLabel title, name, roll, regd, course, child, Native, join, pass, conduct, fees, issue, select, login_text, login_warn, uim, pim, tl, clrnce, regd_no, msg, branch, gender, reg_no, print_warn, topLabel, l1, l2, l3, l4, l5, l6, l7, l8, l9, confT, conf_2, igitLogo1, igitLogo2, hl1, hl2, hl3, hl4, hl5, hl6, hl7, hl8, view_label, warnLogin, deptWarn, warningCp;
	static JTextArea confD, tcPrint, cocPrint, cocPrint2, hta1;
	static JTextField fn, mn, ln, gn, rn1, rn2, pl, cn, un, regdNo, regNo, uniqueId, newUniqueId;
	static JPasswordField pw, oldPassword, newPassword, retypePassword;
	static JComboBox year, day, month, jy, py, feen, branch_box, branch_box_2, deptName;
	...
	static String nameC1, nameC2, nameC3, rollC, regdC, guardC, courseC, placeC, conductC, jyC, pyC, feesC, genC, branchC, dayC, m, yearC, issueDateTc, issueDateCoc, monthC, deptNameStr, userid, oldPass, u_id1, pw1;
	...
	AppDemo() //Automatic constructor
	{
		...
		ffor=new Font("Calibri",Font.PLAIN,15);
		...
		l9=new JLabel(back_img);
		l9.setBounds(0,0,1250,550);
		...
		login_warn.setBounds(700,410,500,50);
		...
		forgotPassword=new JButton("Click here to change your password");
		forgotPassword.setOpaque(false);
		forgotPassword.setContentAreaFilled(false);
		forgotPassword.setForeground(Color.WHITE);
		forgotPassword.setBounds(700,450,300,40);
		forgotPassword.setFont(ffor);
		forgotPassword.setCursor(cur1);
		...
		deptName.addItem ("Select Department");
		deptName.addItem ("HOD (Chemical Engineering)");
		deptName.addItem ("HOD (Civil Engineering)");
		deptName.addItem ("HOD (Electrical Engineering)");
		deptName.addItem ("HOD (Electronics and TC Engineering)");
		deptName.addItem ("HOD (Mechanical Engineering)");
		deptName.addItem ("HOD (Metallurgy and Materials Engineering)");
		deptName.addItem ("HOD (Computer Science and Applications)");
		deptName.addItem ("HOD (Architecture)");
		deptName.addItem ("Physics");
		deptName.addItem ("Chemistry");
		deptName.addItem ("English");
		deptName.addItem ("Mathematics");
		deptName.addItem ("Workshop");
		deptName.addItem ("Officer-in-charge, Library");
		deptName.addItem ("V.P., Cutural Association");
		deptName.addItem ("V.P., Audio Visual Club");
		deptName.addItem ("V.P., Athletics");
		deptName.addItem ("Academic Section");
		deptName.addItem ("Examination Section");
		deptName.addItem ("Accounts Section");
		deptName.addItem ("Officer-in-charge, Book Bank");
		deptName.addItem ("Hostel Superintendent");
		deptName.addItem ("Programme Officer, NCC");
		deptName.addItem ("Programme Officer, NSS");
		deptName.addItem ("End");
		deptName.setBounds (400,10,450,35);
		deptName.setFont (fff);
		deptName.addItemListener (new ItemListener () {
				public void itemStateChanged (ItemEvent ie) {
					deptNameStateChanged (ie);
				}
			});

		//Warning labels for the change password panel
		deptWarn= new JLabel();
		deptWarn.setBounds (900,10,500,35);
		deptWarn.setForeground (Color.RED);
		deptWarn.setFont (fff);

		//textfield for unique id
		uniqueId= new JTextField ();
		uniqueId.setBounds (400,60,450,35);
		uniqueId.setFont (fff);
		uniqueId.setEditable (false);
		uniqueId.setCursor (cur2);
		uniqueId.setOpaque(false);
		uniqueId.setBorder(BorderFactory.createEmptyBorder());
		uniqueId.addFocusListener (new FocusListener () {
			public void focusGained (FocusEvent fe) {
				uniqueIdFocusGained (fe);
			}
			public void focusLost (FocusEvent fe) {
				uniqueIdFocusLost (fe);
			}
		});

		//oldpassword
		oldPassword= new JPasswordField ();
		oldPassword.setBounds (400,110,450,35);
		oldPassword.setFont (fff);
		oldPassword.setEditable (false);
		oldPassword.setCursor (cur2);
		oldPassword.setOpaque(false);
		oldPassword.setBorder(BorderFactory.createEmptyBorder());
		oldPassword.addFocusListener (new FocusListener () {
			public void focusGained (FocusEvent fe) {
				oldPasswordFocusGained (fe);
			}
			public void focusLost (FocusEvent fe) {
				oldPasswordFocusLost (fe);
			}
		});

		//button to match the old password
		changePassword=new JButton();
		changePassword.setOpaque(false);
		changePassword.setContentAreaFilled(false);
		changePassword.setBorder(BorderFactory.createEmptyBorder());
		changePassword.setBounds(600,160,50,30);
		changePassword.setFont(fff);
		changePassword.setEnabled (false);
		changePassword.setCursor(cur1);
		changePassword.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				changePasswordAction(ae);
			}
		});

		//newpassword
		newPassword= new JPasswordField ();
		newPassword.setBounds (400,260,450,35);
		newPassword.setFont (fff);
		newPassword.setEditable (false);
		newPassword.setCursor (cur2);
		...
		retypePassword.setBounds (400,320,450,35);
		retypePassword.setFont (fff);
		retypePassword.setEditable (false);
		retypePassword.setCursor (cur2);
		retypePassword.setOpaque(false);
		retypePassword.setBorder(BorderFactory.createEmptyBorder());
		retypePassword.addFocusListener (new FocusListener () {
			public void focusGained (FocusEvent fe) {
				retypePasswordFocusGained (fe);
			}
			public void focusLost (FocusEvent fe) {
				retypePasswordFocusLost (fe);
			}
		});

		//new id
		//textfield for unique id
		newUniqueId= new JTextField ();
		newUniqueId.setBounds (400,200,450,35);
		newUniqueId.setFont (fff);
		newUniqueId.setEditable (false);
		newUniqueId.setCursor (cur2);
		newUniqueId.setOpaque(false);
		newUniqueId.setBorder(BorderFactory.createEmptyBorder());
		newUniqueId.addFocusListener (new FocusListener () {
			public void focusGained (FocusEvent fe) {
				newUniqueIdFocusGained (fe);
			}
			public void focusLost (FocusEvent fe) {
				newUniqueIdFocusLost (fe);
			}
		});

		//button to submit the data into the database
		submit_3=new JButton();
		submit_3.setBounds(550,380,100,50);
		submit_3.setOpaque(false);
		submit_3.setContentAreaFilled(false);
		submit_3.setBorder(BorderFactory.createEmptyBorder());
		submit_3.setFont(fff);
		submit_3.setEnabled (false);
		submit_3.setCursor(cur1);
		submit_3.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent ae)
			{
				submit_3Action(ae);
		...
		backToLogin=new JButton("Back To Login Page");
		backToLogin.setBounds(900,440,200,50);
		backToLogin.setOpaque(false);
		backToLogin.setContentAreaFilled(false);
		backToLogin.setBorder(BorderFactory.createEmptyBorder());
		backToLogin.setFont(fff);
		backToLogin.setCursor(cur1);
		...
		//warning label for the whole change password panel
		warningCp= new JLabel ();
		warningCp.setBounds (400,430,500,35);
		warningCp.setFont (fff);
		warningCp.setForeground (Color.RED);
		...
		//adding the components of the cpPanel i.e. the change password panel
		cpPanel.add(deptName);
		cpPanel.add(deptWarn);
		cpPanel.add(uniqueId);
		cpPanel.add(oldPassword);
		cpPanel.add(newPassword);
		cpPanel.add(newUniqueId);
		cpPanel.add(changePassword);
		cpPanel.add(retypePassword);
		cpPanel.add(submit_3);
		cpPanel.add(warningCp);
		cpPanel.add(backToLogin);
		cpPanel.add(l9);
	...
	{	
        ...
        nss.setEnabled(false);
       	...
       	ws.setEnabled(false);
		    ...
		    while(rs.next())
		    {
	   			if((rs.getString(1)).equals("LOGINDETAILS"))
	   		  	ex=true;
	   		}
        	if(!ex)
        	{
				PreparedStatement ps= con.prepareStatement ("create table LoginDetails (serial_no number(5) primary key not null, department_name varchar2(50) unique, user_id varchar2(30) unique, password varchar2(30) unique)");
				ps.executeUpdate();
				ps= con.prepareStatement ("insert into LoginDetails values (1,'HOD (Chemical Engineering)','chemhod','chemhodigit')");
				ps.executeUpdate ();
				ps= con.prepareStatement ("insert into LoginDetails values (2,'HOD (Civil Engineering)','civilhod','civilhodigit')");
				ps.executeUpdate ();
				ps= con.prepareStatement ("insert into LoginDetails values (3,'HOD (Electrical Engineering)','electhod','electhodigit')");
				ps.executeUpdate ();
				ps= con.prepareStatement ("insert into LoginDetails values (4,'HOD (Electronics and TC Engineering)','etchod','etchodigit')");
				ps.executeUpdate ();
				ps= con.prepareStatement ("insert into LoginDetails values (5,'HOD (Mechanical Engineering)','mechhod','mechhodigit')");
				ps.executeUpdate ();
				ps= con.prepareStatement ("insert into LoginDetails values (6,'HOD (Metallurgy and Materials Engineering)','meta','metaigit')");
				ps.executeUpdate ();
				ps= con.prepareStatement ("insert into LoginDetails values (7,'HOD (Computer Science and Applications)','cseahod','cseahodigit')");
				ps.executeUpdate ();
				ps= con.prepareStatement ("insert into LoginDetails values (8,'HOD (Architecture)','archhod','archhodigit')");
				ps.executeUpdate ();
				ps= con.prepareStatement ("insert into LoginDetails values (9,'Physics','phy','phyigit')");
				ps.executeUpdate ();
				ps= con.prepareStatement ("insert into LoginDetails values (10,'Chemistry','chem','chemigit')");
				ps.executeUpdate ();
				ps= con.prepareStatement ("insert into LoginDetails values (11,'English','eng','engigit')");
				ps.executeUpdate ();
				ps= con.prepareStatement ("insert into LoginDetails values (12,'Mathematics','maths','mathsigit')");
				ps.executeUpdate ();
				ps= con.prepareStatement ("insert into LoginDetails values (13,'Workshop','ws','wsigit')");
				ps.executeUpdate ();
				ps= con.prepareStatement ("insert into LoginDetails values (14,'Officer-in-charge, Library','lib','libigit')");
				ps.executeUpdate ();
				ps= con.prepareStatement ("insert into LoginDetails values (15,'V.P., Cutural Association','cult','cultigit')");
				ps.executeUpdate ();
				ps= con.prepareStatement ("insert into LoginDetails values (16,'V.P., Audio Visual Club','avclub','avclubigit')");
				ps.executeUpdate ();
				ps= con.prepareStatement ("insert into LoginDetails values (17,'V.P., Athletics','athl','athligit')");
				ps.executeUpdate ();
				ps= con.prepareStatement ("insert into LoginDetails values (18,'Academic Section','acad','acadigit')");
				ps.executeUpdate ();
				ps= con.prepareStatement ("insert into LoginDetails values (19,'Examination Section','exam','examigit')");
				ps.executeUpdate ();
				ps= con.prepareStatement ("insert into LoginDetails values (20,'Accounts Section','acc','accigit')");
				ps.executeUpdate ();
				ps= con.prepareStatement ("insert into LoginDetails values (21,'Officer-in-charge, Book Bank','bb','bbigit')");
				ps.executeUpdate ();
				ps= con.prepareStatement ("insert into LoginDetails values (22,'Hostel Superintendent','hostel','hosteligit')");
				ps.executeUpdate ();
				ps= con.prepareStatement ("insert into LoginDetails values (23,'Programme Officer, NCC','ncc','nccigit')");
				ps.executeUpdate ();
				ps= con.prepareStatement ("insert into LoginDetails values (24,'Programme Officer, NSS','nss','nssigit')");
				ps.executeUpdate ();
				ps= con.prepareStatement ("insert into LoginDetails values (25,'End','end','endigit')");
				ps.executeUpdate ();
    	    }	
        	String u_id2=un.getText();
        	String pw2=pw.getText();
			String sq = "select * from LoginDetails where user_id=?";
        	PreparedStatement ps = con.prepareStatement(sq);
        	ps.setString (1,u_id2);
        	...
        	while(rs1.next())
        	{
				...
				String deptStr= rs1.getString ("department_name");
				if (deptStr.equals ("End")) {
					p_s.add (prt);
					p_s.add (l2);
				}
				else
	...
	public void itemStateChanged(ItemEvent ie)
	{
		...
		if(phy.isSelected()==true&&chem.isSelected()==true&&maths.isSelected()==true&&eng.isSelected()==true&&(phy.isEnabled()==true||chem.isEnabled()==true||maths.isEnabled()==true||eng.isEnabled()==true))
			coord.setEnabled(true);
		if(carp.isSelected()==true&&fit.isSelected()==true&&weld.isSelected()==true&&bs.isSelected()==true&&turn.isSelected()==true&&ms.isSelected()==true&&sm.isSelected()==true&&mound.isSelected()==true&&carp.isEnabled()==true&&fit.isEnabled()==true&&weld.isEnabled()==true&&bs.isEnabled()==true&&turn.isEnabled()==true&&ms.isEnabled()==true&&sm.isEnabled()==true&&mound.isEnabled()==true)
			ws.setEnabled(true);
	...
	static void okAction(ActionEvent ae) //actions to be performed on click of the ok button of the clearance page
	{
		...
		try
		{
			...
			pst= con.prepareStatement ("select department_name from LoginDetails where user_id=?");
			pst.setString (1,u_id1);
			ResultSet rs2= pst.executeQuery ();
			String deptNameString="";
			while (rs2.next())
			{
				deptNameString= rs2.getString (1);
				if (deptNameString.equals ("HOD (Chemical Engineering)")&&branchName.equals ("Chemical Engineering"))
					Hod.setEnabled (true);
				else if (deptNameString.equals ("HOD (Civil Engineering)")&&branchName.equals ("Civil Engineering"))
					Hod.setEnabled (true);
				else if (deptNameString.equals ("HOD (Electrical Engineering)")&&branchName.equals ("Electrical Engineering"))
					Hod.setEnabled (true);
				else if (deptNameString.equals ("HOD (Electronics and TC Engineering)")&& (branchName.equals ("Electronics and Telecommunication Engineering")||branchName.equals ("Electronics and Telecommunication Engineering (SSC)")))
					Hod.setEnabled (true);
				else if (deptNameString.equals ("HOD (Mechanical Engineering)")&& (branchName.equals ("Mechanical Engineering")||branchName.equals ("Mechanical System Design")))
					Hod.setEnabled (true);
				else if (deptNameString.equals ("HOD (Metallurgy and Materials Engineering)")&& (branchName.equals ("Metallurgical and Materials Engineering")||branchName.equals ("Metallurgical Engineering")))
					Hod.setEnabled (true);
				else if (deptNameString.equals ("HOD (Computer Science and Applications)")&& (branchName.equals ("Computer Science and Engineering")||branchName.equals ("Computer Science and Engineering (SSC)")||branchName.equals ("Computer Science and Information Security")||branchName.equals ("Master in Computer Application")))
					Hod.setEnabled (true);
				else if (deptNameString.equals ("HOD (Architecture)")&&branchName.equals ("Architecture"))
					Hod.setEnabled (true);
				else if (deptNameString.equals("Physics"))
					phy.setEnabled(true);
				else if (deptNameString.equals("Chemistry"))
					chem.setEnabled(true);
				else if (deptNameString.equals("English"))
					eng.setEnabled(true);
				else if (deptNameString.equals("Mathematics"))
					maths.setEnabled(true);
				else if (deptNameString.equals("Workshop")) {
        			...
        			turn.setEnabled(true);
       				ms.setEnabled(true);
        			sm.setEnabled(true);
       	 			mound.setEnabled(true);
				}
				else if (deptNameString.equals("Officer-in-charge, Library"))
					lib.setEnabled(true);
				else if (deptNameString.equals("V.P., Cutural Association"))
					cult.setEnabled(true);
				else if (deptNameString.equals("V.P., Audio Visual Club"))
					avc.setEnabled(true);
				else if (deptNameString.equals("V.P., Athletics"))
					athl.setEnabled(true);
				else if (deptNameString.equals("Academic Section"))
					acad.setEnabled(true);
				else if (deptNameString.equals("Examination Section"))
					exam.setEnabled(true);
				else if (deptNameString.equals("Accounts Section"))
					acc.setEnabled(true);
				else if (deptNameString.equals("Officer-in-charge, Book Bank"))
					bb.setEnabled(true);
				else if (deptNameString.equals("Hostel Superintendent"))
					host.setEnabled(true);
				else if (deptNameString.equals("Programme Officer, NCC"))
					ncc.setEnabled(true);
				else if (deptNameString.equals("Programme Officer, NSS"))
					nss.setEnabled(true);
				else if (deptNameString.equals("End")) {}
				else {
					msg.setText ("Not allowed!");
					Hod.setEnabled(false);
        			phy.setEnabled(false);
			        chem.setEnabled(false);
        			maths.setEnabled(false);
	...
	static void OkAction(ActionEvent ae) //actions to be performed on click of the ok button of the print page
	{
        ...
        while(rs.next())
        {
            ...
            {
            	print_warn.setText ("Clearance is not complete!");
            	tc.setEnabled(false);
            	tc.setSelected(false);
            	coc.setEnabled(false);
            	coc.setSelected(false);
        ...
        if (flag==0)
        	print_warn.setText ("Registration number does not exist!");
        }
        catch(Exception e)
        {
	...
	//actions to be performed on click of change password button
	static void forgotAction (ActionEvent ae) {
		//
		cl.last(p);
		/*cpPanel.add(home);
		cpPanel.add(logout);*/
		deptName.setEnabled (true);
		deptName.setSelectedItem ("Select Department");
		warningCp.setText ("");
		deptWarn.setText ("");
		cpPanel.add(l9);
	}

	//actions for dept box
	static void deptNameStateChanged (ItemEvent ie) {
		deptNameStr= (String) deptName.getSelectedItem ();
		if (deptNameStr.equals ("Select Department")) {
			deptWarn.setText ("Please choose a valid department!");
			uniqueId.setText ("");
			uniqueId.setEditable (false);
			newUniqueId.setText ("");
			newUniqueId.setEditable (false);
			...
			deptWarn.setText ("");
			uniqueId.setForeground (Color.GRAY);
			uniqueId.setText ("Enter Username");
			uniqueId.setEditable (true);
	...
	//focus listeners for uniqueID
	static void uniqueIdFocusGained (FocusEvent fe) {
		if (uniqueId.getText ().equals ("Enter Username")) {
			uniqueId.setText ("");
			uniqueId.setForeground (Color.BLACK);
		}
	}

	static void uniqueIdFocusLost (FocusEvent fe) {
	...
	//focus listeners for newUniqueID
	static void newUniqueIdFocusGained (FocusEvent fe) {
		if (newUniqueId.getText ().equals ("New Username")) {
			newUniqueId.setText ("");
			newUniqueId.setForeground (Color.BLACK);
		}
	}

	static void newUniqueIdFocusLost (FocusEvent fe) {
		if (newUniqueId.getText ().equals ("")) {
			newUniqueId.setText ("New Username");
			newUniqueId.setForeground (Color.GRAY);
		}
	}

	//focus listeners for password fields
	static void oldPasswordFocusGained (FocusEvent fe) {
	...
	static void oldPasswordFocusLost (FocusEvent fe) {
	...
	static void newPasswordFocusGained (FocusEvent fe) {
	...
	static void newPasswordFocusLost (FocusEvent fe) {
	...
	static void retypePasswordFocusGained (FocusEvent fe) {
		if (retypePassword.getText ().equals ("Retype Password")) {
			retypePassword.setText ("");
	...
	static void retypePasswordFocusLost (FocusEvent fe) {
		if (retypePassword.getText ().equals ("")) {
			retypePassword.setText ("Retype Password");
			retypePassword.setForeground (Color.GRAY);
			retypePassword.setEchoChar ((char)0);
		}
	}

	//actions to be performed on click of ok button on the change password page
	static void changePasswordAction (ActionEvent ae) {
		try {
			PreparedStatement ps= con.prepareStatement ("select * from LoginDetails");
			userid= uniqueId.getText ();
			oldPass= oldPassword.getText ();
			int flag= 0;
			//System.out.println (userid+" "+deptNameStr+" "+pass);
			ResultSet rs= ps.executeQuery ();
			while (rs.next ()) {
				if (deptNameStr.equals (rs.getString (2)) && userid.equals (rs.getString (3)) && oldPass.equals (rs.getString (4))) {
					newUniqueId.setForeground (Color.GRAY);
					newUniqueId.setText ("New Username");
					newUniqueId.setEditable (true);
					...
					uniqueId.setText("");
					uniqueId.setEditable (false);
					submit_3.setEnabled (true);
					submit_3.setText ("Submit");
					flag++;
					warningCp.setText ("");
				}
			}
			if (flag==0)
				warningCp.setText ("Department details didn't match!");
		}
		catch (Exception e) {
			e.printStackTrace ();
		}
	...
	static void submit_3Action (ActionEvent ae) {
		String newPass= newPassword.getText ();
		String retypePass= retypePassword.getText ();
		String newId= newUniqueId.getText ();
		if (!newPass.equals(retypePass))
			warningCp.setText ("Passwords are different!");
		else if (userid.equals (newId))
			warningCp.setText ("Your new username is too similar to your old username!");
		else if (newPass.equals (oldPass)) 
			warningCp.setText ("Your new password is too similar to your old password!");
		else {
			try {
				PreparedStatement ps= con.prepareStatement ("update LoginDetails set user_id=?, password=? where user_id=?");
				ps.setString (1,newId);
				ps.setString (2,newPass);
				ps.setString (3,userid);
				int status= ps.executeUpdate ();
				if (status!=0) {
					warningCp.setText ("Saved Successfully!");
					newUniqueId.setText ("");
					newUniqueId.setEditable (false);
					newPassword.setText ("");
					newPassword.setEditable (false);
					...
					warningCp.setText ("Error!");
			}
			catch (Exception e) {
				warningCp.setText ("Database error!");
			}
		}
	}

	static void backToLoginAction (ActionEvent ae) {
		cl.first (p);
	}
}
